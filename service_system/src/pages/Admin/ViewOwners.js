...
export default function ViewOwners(props) {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: {
        compare: (a, b) =>
          a.number_of_properties_owned - b.number_of_properties_owned,
        multiple: 1,
      },
    },
    {
      ...
      sorter: {
        compare: (a, b) =>
          a.average_property_rating - b.average_property_rating,
        multiple: 1,
      },
    },
  ];
  ...
  const inputFilter = (value) => {
    ...
    setFiltered(
      owners.filter((owner) =>
        owner.name.toLowerCase().startsWith(value.toLowerCase())
      )
    );
          ...
          <Col xs={22} sm={20} md={16} lg={15} xl={15} xxl={15}>
            <Row justify="center" align="middle" gutter={[24, 24]}>
              <Col span={24} align="middle">
                ...
                <h1 className="heading">View Owners</h1>
              </Col>
              <Col span={24} align="middle">
                <p>
                  Name:
